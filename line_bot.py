...
def handle_message(event):
    ...
    print(json.dumps(event.to_dict(), indent=4, ensure_ascii=False))
    ...
    # ------------------------
        ...
        if len(parts) >= 2 and parts[-1].isdigit() and len(parts[-1]) == 4:
            ...
            kill_time = parts[-1]
            reply = register_boss(boss_name, kill_time)
        else:
            boss_name = content
            reply = register_boss(boss_name)
